...
public class NewsArticleService {
	...
	public List<NewsArticle> getArticlesByDateRange(LocalDate startDate, LocalDate endDate) throws IOException, InterruptedException {
	...
	public List<NewsArticle> getArticlesByFilters(LocalDate startDate, LocalDate endDate, String categoryId) throws IOException, InterruptedException {
